...
Name:           ros-humble-linear-feedback-controller
Version:        4.0.1
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS linear_feedback_controller package
...
Requires:       ros-humble-linear-feedback-controller-msgs
Requires:       ros-humble-message-filters
Requires:       ros-humble-nav-msgs
Requires:       ros-humble-pal-statistics
...
BuildRequires:  ros-humble-linear-feedback-controller-msgs
BuildRequires:  ros-humble-message-filters
BuildRequires:  ros-humble-nav-msgs
BuildRequires:  ros-humble-pal-statistics
...
BuildRequires:  ros-humble-gmock-vendor
...
%changelog
* Fri Jun 05 2026 Guilhem Saurel <guilhem.saurel@laas.fr> - 4.0.1-1
